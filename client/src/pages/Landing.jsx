...
export default function Landing() {
    ...
    return (
        <div className="min-h-screen bg-surface-950 overflow-hidden">
            ...
            {/* Hero */}
            <section className="relative px-8 py-24 flex flex-col items-center text-center">
                {/* Glow background */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-radial from-gold-500/10 via-transparent to-transparent blur-3xl pointer-events-none" />
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-white leading-tight max-w-4xl">
                        Track. Detect.{' '}
                        <span className="gradient-text">Optimize.</span>
                    </h1>

                    <p className="mt-6 text-lg text-white/50 max-w-2xl mx-auto leading-relaxed">
                        {APP_TAGLINE}. AI-powered platform tracking public fund flows across
                ...
                <motion.div
                    ...
                    className="relative z-10 mt-20 grid grid-cols-4 gap-8 glass-card px-12 py-6"
                >
                    {stats.map((stat, i) => (
